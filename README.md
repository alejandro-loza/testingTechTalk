...
* [java 8](https://docs.oracle.com/javase/8/docs/api/java/lang/package-summary.html) - Programming Language
...
testingTechTalk need installed [Docker](https://docs.docker.com/install/)
